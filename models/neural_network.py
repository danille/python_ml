...
class Perceptron(object):
    ...
    def __init__(self, eta: float = 0.01, n_epochs: int = 50, random_state: bool = 1):
        self.eta = eta
...
class AdalineSGD(object):
    ...
    def __init__(self, eta=0.01, n_epochs=10, shuffle=True, random_state=None):
        self.eta = eta
        self.n_epochs = n_epochs
...
class LogisticRegressionGD:
    ...
    def fit(self, X, y):
        ...
        X: {array-like}, shape = [n_samples, m_features]
            Training vectors, where n_samples is a number of samples and m_features 
